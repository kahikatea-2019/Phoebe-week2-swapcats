  ...
  return knex('products').del()
    ...
    // Inserts seed entries
      return knex('products').insert([
        ...
        { id: 12, product_category: 'phone', product_description: "Azaan's phone", img_url: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQLrjP2nsfTyAn2AVMkLXzEcKWaKqyNqKPiVlJCNb1UMpghdQrF', user_id: 10002 },
